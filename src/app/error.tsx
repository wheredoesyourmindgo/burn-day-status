...
export default function Error({
  ...
  return (
    <main className="flex h-dvh flex-col items-center justify-center overflow-hidden bg-gradient-to-b from-purple-500 to-purple-700 px-6 text-center text-white">
      ...
      <button
        onClick={() => reset()}
        className="rounded-md border border-white/30 px-5 py-2 text-sm font-medium transition-colors hover:bg-white/10 focus-visible:ring-2 focus-visible:ring-white/70 focus-visible:ring-offset-2 focus-visible:ring-offset-transparent focus-visible:outline-none"
      >
        Try again
      </button>
    </main>
