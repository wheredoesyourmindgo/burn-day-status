      ...
      <PopoverTrigger asChild>
        ...
        >
          <Calendar
            ...
            strokeWidth={1}
          />
          <span className="font-display pointer-events-none absolute top-[28px] left-[35px] -translate-x-1/2 text-[13px] font-semibold tracking-wide text-white/85 uppercase antialiased transition-colors transition-transform duration-150 ease-out group-hover:scale-105 group-hover:text-white group-active:scale-95">
            {monthAbbrev}
          </span>
